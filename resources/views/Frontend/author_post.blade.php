      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9" data-aos="fade-up">
            <h3 class="category-title">Writter:{{$user->name}} </h3>
           ...
           @foreach ($author_posts as $author_post)
               ...
               <div class="d-md-flex post-entry-2 half">
                   <a href="single-post.html" class="me-4 thumbnail">
                     <img src="{{asset('dashboard_post')}}/{{$author_post->featured_image}}" alt="" class="img-fluid">
                   </a>
                   <div>
                    <div class="post-meta"><span class="date">{{$author_post->rel_to_category->category_name}}</span> <span class="mx-1">&bullet;</span> <span>{{$author_post->created_at->format('M-d-Y')}}</span></div>                   
                      <h3><a href="{{route('post_even.details', $author_post->id)}}">{{$author_post->title}}</a></h3>
